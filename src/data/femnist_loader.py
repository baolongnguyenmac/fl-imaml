...
def get_loader(file_path: str, batch_size: int=32, shuffle: bool=True, split_supp_query:bool = True) -> DataLoader:
    ...
    if split_supp_query:
        ...
        # return 2loaders
        support_set, query_set = FemnistDataset(X_support, y_support), FemnistDataset(X_query, y_query)
        ...
        return DataLoader(FemnistDataset(X, y), batch_size=batch_size, shuffle=shuffle)
